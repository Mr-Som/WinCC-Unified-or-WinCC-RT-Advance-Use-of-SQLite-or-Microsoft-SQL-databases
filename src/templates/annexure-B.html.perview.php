...
<body>
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0 gridlines" style="width: 100%;">
        ...
        <tbody>
            ...
            <tr class="row3">
                <td class="column0 style4 null style4" colspan="11"></td>
            </tr>
            <tr class="row4">
            ...
            <tr class="row31">
                <td class="column0 style42 null style42" colspan="11"></td>
            </tr>
            <tr class="row32">
                <td class="column0 style43 s style43" colspan="11">Note- <span style="color:#000000; font-size:10pt">Ensure clearance of 5mm between Brake block and wheel during check.</span></td>
            </tr>
        </tbody>
    </table>
</body>
